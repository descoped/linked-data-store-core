package io.descoped.lds.core.domain.managed;
...
public class ManagedTimeBasedVersioningTest {
    ...
    public void thatCorrectVersionIsReturned() {
        ...
        client.put("/data/provisionagreement/A1?sync=true&timestamp=2016-01-01T00%3A00%3A00.000%2B01", body2016).expect201Created();
        client.put("/data/provisionagreement/A1?sync=true&timestamp=2017-01-01T00%3A00%3A00.000%2B01", body2017).expect201Created();
        client.put("/data/provisionagreement/A1?sync=true&timestamp=2018-01-01T00%3A00%3A00.000%2B01", body2018).expect201Created();
